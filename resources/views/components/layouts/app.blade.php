        ...
        <aside class="w-64 bg-slate-900 text-white flex flex-col transition-all duration-300">
            <div class="p-6 border-b border-slate-800 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xs font-black text-slate-500 bg-slate-800 px-2 py-0.5 rounded-md">2.0</span>
                </div>
                ...
                <ul class="space-y-6 px-3">
                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="{{ route('gis.port-map') }}" class="flex items-center px-3 py-2 rounded-lg group {{ request()->routeIs('gis.port-map') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                                    ...
                                    <span class="ml-3">GIS Port Map</span>
                                </a>
                            </li>
                            @endif
                    ...
                    <li>
                        ...
                        <ul class="space-y-1">
                            ...
                            @if(auth()->user()->role === 'admin')
                            <li>
                                <a href="{{ route('maritime.pilotage-towage') }}" class="flex items-center px-3 py-2 rounded-lg group {{ request()->routeIs('maritime.*') ? 'bg-slate-800 text-white' : 'text-slate-300 hover:bg-slate-800 hover:text-white' }}">
                                    ...
                                    <span class="ml-3">Pilotage & Towage</span>
                                </a>
                            </li>
                            <li>

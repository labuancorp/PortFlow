            ...
            <nav class="flex-1 overflow-y-auto py-4">
                <ul class="space-y-1 px-3">
                    ...
                    <li class="mt-8 border-t border-slate-800 pt-4">
                        ...
                        <a href="{{ route('admin.health') }}" class="flex items-center px-3 py-2 rounded-lg group {{ request()->routeIs('admin.*') ? 'bg-red-900/20 text-red-400' : 'text-slate-400 hover:bg-slate-800 hover:text-red-400' }}">
